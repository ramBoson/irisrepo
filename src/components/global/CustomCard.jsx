...
const CustomCard = ({ title,title2, text, subText,subText1,titledashboard }) => {
    return (
        <Card className="custom-card p-24 ">
            <small className="text-site-primary font-weight-semi-bold text-uppercase text-color" color="#2a7cda">{title}</small>            
            <small className="text-site-primary font-weight-semi-bold  text-color" color="#2a7cda">{titledashboard}</small>            
